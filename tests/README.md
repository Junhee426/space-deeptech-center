...
Coverage: 10 views at 1440/1024/390px; visible run buttons; shared mission geometry; PHY and beamforming architecture labels; ISL visibility; calculated SVG dimensions; invalid input; stale responses; error messages; warning stability; saved scenario restoration; Optimizer execution. The Python regression checks both integrated evaluation paths with a non-default Walker geometry.
